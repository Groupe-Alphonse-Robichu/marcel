...
TRANSLATIONS = {
    ...
    u'barrage': u'wait',
    u'socialistes': u'ps',
    u'trois-dimensions': u'volume',
    u'halte-là': u'stop',
    u'composer': u'compose',
    u'essaim': u'swarm',
    u'nœud': u'node',
    u'noeud': u'node',
    u'greffon': u'plugin',
    u'pile': u'stack',
    u'confiance': u'trust',
    u'classe-préparatoire': u'cp',
    u'génèse': u'create',
    u'tractage': u'diff',
    u'festival': u'events',
    u'commerce-sortant': u'export',
    u'commerce-entrant': u'import',
    u'relance': u'restart',
    u'déguerpissez': u'rm',
    u'réforme': u'update',
    u'ancienneté': u'version',
    # Management
    u'contremaître': u'builder',
    u'situation': u'context',
    u'thèse': u'manifest',
    u'sûreté-nationale': u'secret',
    u'fonction-publique': u'service',
    # Options
    u'--aide': u'--help',
    u'--graffiti': u'--tag',
    u'--sortie': u'--output',
